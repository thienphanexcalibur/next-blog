  ...
  <section className="py-24 text-center">
    <div className="container">
      ...
      <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
        Move beyond &ldquo;just lift heavy.&rdquo; This guide translates the
        science of training volume into a practical, interactive framework to
        help you build a smarter, stronger program.
      </p>
...
export default function PowerliftingPage() {
  ...
  const periodizationBlocks = [
    {
      ...
      description:
        "This is your high-volume, muscle-building phase. It lays the foundation for future strength.",
      details: [
    ...
    },
    {
      ...
      description:
        "Convert new muscle into usable strength with higher intensity and lower volume.",
      details: [
    ...
    },
    {
      ...
      description:
        "Peak your strength and shed fatigue to prepare for a meet or testing your 1RM.",
      details: [
  ...
  const volumeLandmarks = [
    ...
    },
    {
      ...
      description:
        "The minimum to make new gains (~10-12 sets/week to start a block).",
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    ...
                    per muscle group, where a hard set is taken close to
                    muscular failure (0-4 Reps in Reserve).
                  </p>
                </CardContent>
              </Card>
          ...
          <div className="container space-y-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-center max-w-2xl mx-auto">
                  Use these concepts, measured in weekly hard sets, as a GPS for
                  your training. Start at MEV, progress towards MRV, then
                  deload.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-center max-w-2xl mx-auto">
                  Your ability to perform changes daily. Autoregulation (using
                  RPE/RIR) lets you adjust your training to match your
                  readiness.
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="container space-y-8">
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Provides the fuel for performance and the raw materials for
                    repair.
                  </p>
                </CardContent>
              </Card>
