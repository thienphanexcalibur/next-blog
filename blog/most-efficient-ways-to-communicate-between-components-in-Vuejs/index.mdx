...
description: VueJS has increasingly become a top of mind framework in front end development lately. By reckoning, it harnesses the best features of both ReactJS and AngularJS and did a good job in both DOM manipulations and State Mangement (Vuex).
date: '2018-07-21T22:40:32.169Z'
id: 7856
cover: /cover/vue-cover.jpeg
---
...
<Note type="error">id must be declared as a prop in component B</Note>
